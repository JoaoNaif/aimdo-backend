...
describe('Decline Objective Invite (E2E)', () => {
  ...
  test('[PUT] /objective/:inviteId/to/:collaboratorId', async () => {
    ...
    const response = await request(app.getHttpServer())
      .put(
        `/objective/${objectiveInvite.id.toString()}/to/${collaborator.id.toString()}`
      )
